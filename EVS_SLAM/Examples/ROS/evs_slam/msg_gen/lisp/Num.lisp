...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orb_slam2-msg:<Num> is deprecated: use orb_slam2-msg:Num instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam2-msg:name-val is deprecated.  Use orb_slam2-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam2-msg:age-val is deprecated.  Use orb_slam2-msg:age instead.")
  (age m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Num>)))
  ...
  "23b9bccd17c8042888a78e4f556ccd59")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Num)))
  "Returns md5sum for a message object of type 'Num"
  "23b9bccd17c8042888a78e4f556ccd59")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Num>)))
  ...
  (cl:format cl:nil "string name~%int8 age~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Num)))
  "Returns full string definition for message of type 'Num"
  (cl:format cl:nil "string name~%int8 age~%~%~%"))
